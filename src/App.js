...
function App() {
    ...
    useEffect(() => {
        const getMyNfts = async () => {
            const openSeadata = await axios.get('https://testnets-api.opensea.io/assets?asset_contract_address=0x5AE17A3ff84b10c047Fe1685502Ce92911ff13b3&order_direction=asc')
